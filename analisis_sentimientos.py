...
def printSentimentAnalysis(api, lista_peliculas) -> list:
    ...
    for i in range(len(lista_peliculas)):
        ...
        tweets = api.get_tweets(api, query = lista_peliculas[i], count = 200)
...
def menu_analisis_sentimientos(api):
...
def main():
    ...
    while True:
        response = requests.get(URL_MOVIES_THEATERS)
        ...
        try:
            ...
            if option == 1:
                ...
                menu_analisis_sentimientos(api)
